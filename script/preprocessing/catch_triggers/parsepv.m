...
%
%   JRI 4/18/13 modified to allow novel properties to be passed in (ones that were not in defaults)
%               this way don't have to specify default for every property
...
% end
if length(prop_index) > 1
	error('Property ''%s'' is ambiguous.',arg)
end
