...
pos1 = [(screen(3)*0.5)/20 ((screen(4)*10)/20) ((screen(3)*2)/6) ((screen(4)*2.8)/6)];
...
pos2 = [((screen(3)*0.5)/20) ((screen(4)*0)/7) ((screen(3)*2)/6) ((screen(4)*3)/7)];
...
pos3 = [((screen(3)*0)) ((screen(4)*0)) ((screen(3)* 0)) ((screen(4)*0)/7)];
...
pos4 = [(screen(3)*10.75)/12 ((screen(4)*1.6)/7) (screen(3)/11.5) ((screen(4)*1.25)/7)];
...
pos6 = [((screen(3)*4)/6) ((screen(4)*1.6)/7) ((screen(3)*1.35)/6) ((screen(4)*1.25)/7)];
...
pos7 = [((screen(3)*4)/6) ((screen(4)*0.1)/7) ((screen(3)*1.35)/6) ((screen(4)*1.25)/7)];
