...
%         if rp(in)>0.5
%           async_relp(in) = t2(in) - te(i); %will be <0
%         else
%           async_relp(in) = t2(in) - ts(i);
%         end
    end
end
